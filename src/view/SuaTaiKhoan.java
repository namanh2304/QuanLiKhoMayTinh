...
public class SuaTaiKhoan extends javax.swing.JDialog {
     ...
     */
    public SuaTaiKhoan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        vaitro.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        btnupdate.setBackground(javax.swing.UIManager.getDefaults().getColor("Actions.Blue"));
        ...
        trangthai.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SuaTaiKhoan dialog = new SuaTaiKhoan(new javax.swing.JFrame(), true);
