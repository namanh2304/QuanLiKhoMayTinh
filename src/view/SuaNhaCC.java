 ...
 * @author thanh
 */
public class SuaNhaCC extends javax.swing.JDialog {

    /**
     * Creates new form SuaNhaCC
     */
    public SuaNhaCC(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SuaNhaCC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SuaNhaCC dialog = new SuaNhaCC(new javax.swing.JFrame(), true);
