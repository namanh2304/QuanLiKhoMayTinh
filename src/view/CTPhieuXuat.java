...
public class CTPhieuXuat extends javax.swing.JDialog {
    ...
    /**
     * Creates new form CTPhieuXuat
     */
    public CTPhieuXuat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(822, 493));
        ...
        exportPDF.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/export pdf.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CTPhieuXuat dialog = new CTPhieuXuat(new javax.swing.JFrame(), true);
